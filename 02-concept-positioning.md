...
One pattern that works: **combine two proven pillars that nobody offers together in your market** — an offer validated by one set of competitors, a format validated by another. Your reference concepts (Step 0 of the market study) are the raw material; the combination is yours. Verify in the competitor grid that the combination count really is zero, then stress-test whether the two pillars actually reinforce each other (Step 6).
...
> **[Name]** is a **[type of place]** for **[target customer]** who want **[core need/occasion]**, offering **[signature offer]** at **[price point]**, unlike **[main alternative]** which **[their weakness]**.
...
|---|---|---|---|
| Who (age, situation) | | | |
| Occasion (lunch break, date, family…) | | | |
| Frequency (×/month) | | | |
| Budget for this occasion | | | |
| What makes them choose a place | | | |
| Where they go today | | | |
...
- Price (low → high) × Experience (functional → destination)
- Traditional (classic → creative) × Service (fast-casual → full service)
...
- **Menu length:** short menus (≤ 8 mains) mean less waste, faster kitchen, clearer identity. Every extra dish must justify its cost in stock and complexity.
- **Signature items (1–3):** what will people photograph, remember and come back for?
- **Margin mix:** pair high-food-cost stars with high-margin items (starters, sides, desserts, drinks). The financial model (`03-financial-model.xlsx`, *Pricing* tab) prices each item.
...
1. If the restaurant next door copied my menu tomorrow, what would I still have?
2. What am I deliberately choosing **not** to offer? (No trade-off = no positioning.)
3. Would my target persona cross the street past 3 competitors to reach me? Why?
4. Does the concept survive month 4, when novelty wears off and regulars are what pay rent?
5. Can the concept be explained by a customer to a friend in one sentence — the same sentence as Step 1?

---

*Next step → plug your hypotheses into [`03-financial-model.xlsx`](03-financial-model.xlsx)*
